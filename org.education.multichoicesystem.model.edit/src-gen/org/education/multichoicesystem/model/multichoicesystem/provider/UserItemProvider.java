...
/**
 * This is the item provider adapter for a {@link org.education.multichoicesystem.model.multichoicesystem.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MultichoicesystemPackage.Literals.USER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPwdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_pwd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_pwd_feature", "_UI_User_type"),
				 MultichoicesystemPackage.Literals.USER__PWD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MultichoicesystemPackage.Literals.USER__FILLED_QC_MS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MultichoicesystemPackage.Literals.USER__FILLED_QC_MS,
				 MultichoicesystemFactory.eINSTANCE.createMultipleChoiceInst()));
	}
