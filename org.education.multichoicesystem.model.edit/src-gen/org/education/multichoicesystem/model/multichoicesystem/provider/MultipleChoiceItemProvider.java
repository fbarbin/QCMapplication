...
/**
 * This is the item provider adapter for a {@link org.education.multichoicesystem.model.multichoicesystem.MultipleChoice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultipleChoiceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultipleChoice_timeLimit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultipleChoice_timeLimit_feature", "_UI_MultipleChoice_type"),
				 MultichoicesystemPackage.Literals.MULTIPLE_CHOICE__TIME_LIMIT,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultipleChoice_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultipleChoice_name_feature", "_UI_MultipleChoice_type"),
				 MultichoicesystemPackage.Literals.MULTIPLE_CHOICE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MultichoicesystemPackage.Literals.MULTIPLE_CHOICE__STATEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MultichoicesystemPackage.Literals.MULTIPLE_CHOICE__STATEMENTS,
				 MultichoicesystemFactory.eINSTANCE.createStatement()));
	}
