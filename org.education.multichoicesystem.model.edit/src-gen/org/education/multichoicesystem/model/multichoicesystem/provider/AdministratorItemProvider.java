...
/**
 * This is the item provider adapter for a {@link org.education.multichoicesystem.model.multichoicesystem.Administrator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdministratorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Administrator_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Administrator_name_feature", "_UI_Administrator_type"),
				 MultichoicesystemPackage.Literals.ADMINISTRATOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPwdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Administrator_pwd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Administrator_pwd_feature", "_UI_Administrator_type"),
				 MultichoicesystemPackage.Literals.ADMINISTRATOR__PWD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MultichoicesystemPackage.Literals.ADMINISTRATOR__MULTIPLE_CHOICES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MultichoicesystemPackage.Literals.ADMINISTRATOR__MULTIPLE_CHOICES,
				 MultichoicesystemFactory.eINSTANCE.createMultipleChoice()));
	}
